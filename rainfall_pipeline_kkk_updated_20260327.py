...
PIPELINE_BASE_DIR = Path(__file__).resolve().parent.parent
PIPELINE_LOG_DIR = PIPELINE_BASE_DIR / "data" / "rainfall_logs"
...
cde_run_dte = datetime.utcnow().strftime('%Y%m%d')
